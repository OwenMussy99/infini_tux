...
public class Art
{
    ...
    public static Image controlsMsg; // Prompt for showing controls.
    public static Image showControls; // For controls of game.
    ...
    public static void init(GraphicsConfiguration gc, SonarSoundEngine sound)
    {
        try
        {
            ...
            controlsMsg = getImage(gc, "/controlsImg.png");
            showControls = getImage(gc, "/controls.png");
